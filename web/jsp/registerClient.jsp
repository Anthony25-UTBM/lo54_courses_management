...
<html>
    ...
    <form action="${pageContext.request.contextPath}/registerClient?idCourseSession=${param.idCourseSession}" method="post"  role="form" data-toggle="validator" >
        ...
        <br/>
            ...
            <div class="form-group col-xs-4">
                ...
                <input type="text" name="phone" class="form-control" id="phone" required="true">
            </div>
            <div class="form-group col-xs-4">
